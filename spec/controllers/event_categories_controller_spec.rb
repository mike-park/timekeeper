...
describe EventCategoriesController do
  ...
  describe "GET index" do
    it "assigns all event_categories as @event_categories" do
      ...
      assigns(:event_categories).should eq([event_category])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created event_category" do
        post :create, {:event_category => valid_attributes}, valid_session
        response.should redirect_to(EventCategory.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved event_category as @event_category" do
        ...
        post :create, {:event_category => { "title" => "invalid value" }}, valid_session
        assigns(:event_category).should be_a_new(EventCategory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested event_category" do
        ...
        EventCategory.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => event_category.to_param, :event_category => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the event_category as @event_category" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        EventCategory.any_instance.stub(:save).and_return(false)
        put :update, {:id => event_category.to_param, :event_category => { "title" => "invalid value" }}, valid_session
        assigns(:event_category).should eq(event_category)
      end
